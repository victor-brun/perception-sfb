...
# PERMANOVA
perm <- adonis2(df[13:37] ~ Knowledge_NGO + Knowledge_MPA + Involved_project + Gender + Residence, data=df, permutations = 999, method = "bray")
perm
...
aov <- anova(lm(N_Perceptions ~ Knowledge_NGO + Knowledge_MPA + Involved_project + Gender + Residence, data=df))
aov
